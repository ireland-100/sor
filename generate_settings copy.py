...
setting_tuples = [ 
    ( "2x2", "totpop_PL",  ["sor_PL_pct"],                 ["hispanic_PL_pct"],           ["hispanic_PL_pct"],                                                         ["sor_PL_pct"],), #why are these what they've been chosen to be? 
    ( "2x2", "totpop_PL",  ["sor_ACS_pct"],                ["brazilian_ACS_pct"],         ["brazilian_ACS_pct"],                                                       ["sor_ACS_pct"],),
    ( "2x2", "totpop_PL",  ["sor_ACS_pct"],                ["guyanese_ACS_pct"],          ["guyanese_ACS_pct"],                                                        ["sor_ACS_pct"],),
    ...
    ( "2x2", "totpop_ACS", ["hispanic_PL_pct"],            ["brazilian_ACS_pct"],         ["brazilian_ACS_pct"],                                                       ["hispanic_PL_pct"],),
    ...
    ( "2x2", "totpop_PL",  ["sor_ACS_pct"],                ["mena_world_bank_ACS_pct"],   ["mena_world_bank_ACS_pct"],                                                 ["sor_ACS_pct"],),
    ...
    ( "2x2", "totpop_ACS", ["white_PL_pct"],               ["mena_world_bank_ACS_pct"],   ["mena_world_bank_ACS_pct"],                                                 ["white_PL_pct"],),
    ( "2x2", "totpop_ACS", ["white_PL_pct"],               ["mena_unhcr_ACS_pct"],        ["mena_unhcr_ACS_pct"],                                                      ["white_PL_pct"],),
    ( "2x2", "totpop_PL",  ["white_PL_pct"],               ["mena_unsd_ACS_pct"],         ["mena_unsd_ACS_pct"],                                                       ["white_PL_pct"],),
